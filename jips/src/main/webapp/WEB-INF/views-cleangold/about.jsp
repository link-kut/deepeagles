...
<body>
    ...
    <section class="container" style=" height:auto;">
        <img src="${resources2}/img/jips/UI/bar_aboutProject.png"width="100%" style="margin-left: auto; margin-right: auto; display: block;">
        <br/>
    ...
    <section class="container" style="height:600px">
        <img src="${resources2}/img/jips/UI/bar_aboutUs.png" width="100%" style="margin-left: auto; margin-right: auto; display: block;">
        <br/>
